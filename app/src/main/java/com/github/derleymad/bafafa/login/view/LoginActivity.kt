...
class LoginActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.login_btn_enter).setOnClickListener{
            findViewById<TextInputLayout>(R.id.login_txt_input_layout_email).error =  "E-mail incorreto"
            findViewById<TextInputLayout>(R.id.login_txt_input_layout_password).error =  "Senha incorreta"
        }
    }
